        ...
        <div className="rounded-xl border border-slate-200 bg-white p-6">
          ...
          <div className="space-y-4">
            <div>
              <label className="flex items-center gap-2 text-sm font-medium text-emerald-700 mb-1">
                <CheckCircle className="h-4 w-4" /> Satisfatório — mínimo (%)
              </label>
              <input
            ...
            <div>
              <label className="flex items-center gap-2 text-sm font-medium text-amber-700 mb-1">
                <AlertTriangle className="h-4 w-4" /> Em desenvolvimento — mínimo (%)
              </label>
              <input
            ...
            <div>
              <label className="flex items-center gap-2 text-sm font-medium text-orange-700 mb-1">
                <AlertCircle className="h-4 w-4" /> Necessita acompanhamento — mínimo (%)
              </label>
              <input
          ...
          <div className="mt-6 p-4 rounded-lg bg-slate-50 border border-slate-200">
            ...
            <div className="space-y-1 text-xs">
              <div className="flex items-center gap-2"><CheckCircle className="h-3.5 w-3.5 text-emerald-600" /> <span className="text-slate-700">Satisfatório: <b>{form.verdeMin}%–100%</b></span></div>
              <div className="flex items-center gap-2"><AlertTriangle className="h-3.5 w-3.5 text-amber-600" /> <span className="text-slate-700">Em desenvolvimento: <b>{form.amareloMin}%–{form.verdeMin - 1}%</b></span></div>
              <div className="flex items-center gap-2"><AlertCircle className="h-3.5 w-3.5 text-orange-600" /> <span className="text-slate-700">Acompanhamento: <b>{form.laranjaMin}%–{form.amareloMin - 1}%</b></span></div>
              <div className="flex items-center gap-2"><XCircle className="h-3.5 w-3.5 text-rose-600" /> <span className="text-slate-700">Intervenção: <b>0%–{form.laranjaMin - 1}%</b></span></div>
            </div>
          </div>
